-- =====================================================
-- FINANCIAL DATA SETUP FOR ACCOUNTS SYSTEM (FIXED)
-- =====================================================
...
SELECT 
    p.id,
    ROUND(RANDOM() * 100000 + 50000)::DECIMAL(12,2), -- Random uloomx income between 50k-150k
    ROUND(RANDOM() * 80000 + 30000)::DECIMAL(12,2), -- Random usthad income between 30k-110k
    ROUND(RANDOM() * 50000 + 20000)::DECIMAL(12,2), -- Random expenses between 20k-70k
    'approved',
    p.id
FROM profiles p 
